...
export const projects = [
    ...
    },
    {
        ...
        description: "Desarrollo de mi sitio personal (este proyecto) adaptando una plantilla de alto rendimiento para demostrar mis habilidades en maquetación moderna y Clean Code.",
        ctaText: "Código en GitHub →",
        ctaLink: "https://github.com/TeoCastellvi", 
        icon: AstroIcon
    }
